...
<div class="body" style="width: 800px;">
	<div>
	<span style="margin-left:250px; font-size:50px;"><i class="fa-solid fa-clipboard-list"></i>訂單清單</span>
					...
					<div style="height:200px;">
						<ul>
							<li class="pro">
								...
								<span style="text-align: left; margin-top:30px;">訂單編號：${list.o_id }</span><hr>
								...
								<form action="orderIServlet?">
									<input type="hidden" name="O_id" value="${list.o_id }">
									<input type="hidden" name="user" value="<%=name%>">
									<button class="btn" style="margin-left:100px; font-size:20px;" type="submit">訂單詳細資訊</button>
								</form>			
							</li>
						</ul>
					</div>
